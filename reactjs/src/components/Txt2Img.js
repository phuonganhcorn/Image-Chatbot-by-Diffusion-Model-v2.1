...
function Txt2Img() {
  ...
  return (
    <div className="txt2img-container">
      ...
      <div className="txt2img-content">
        <div className="input-content">
          <div className="input-prompt">
            <input type="text" id="input-prompt" placeholder="Input Prompt" />
          </div>
          <div className="input-negative-prompt">
            <input
              type="text"
      ...
      <div className="txt2img-wrapper">
        ...
        <div className="generated-images">
          {/* Hiển thị các ảnh trả về sau khi Generate Image */}
        </div>
      </div>
    </div>
  );
